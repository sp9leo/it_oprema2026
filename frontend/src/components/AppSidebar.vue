...
const floorplanIcon = { render: () => h('svg', { viewBox: '0 0 24 24', class: 'w-4 h-4', fill: 'none', stroke: 'currentColor', 'stroke-width': '2', innerHTML: '<rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/>' }) }
...
const sections = [
  {
    ...
    items: [
      ...
      { label: 'Floorplans', icon: floorplanIcon, to: '/floorplans' },
    ],
  },
  {
    label: 'Loans',
